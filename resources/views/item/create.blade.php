                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                <div class="nk-int-st">
                                                    <input type="text" class="form-control input-sm" placeholder="Item Name" name="name" value="{{ old('name') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-example-int form-horizental">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                <div class="nk-int-st">
                                                    <input type="text" class="form-control input-sm" placeholder="Category Name" name="category" value="{{ old('category') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-example-int form-horizental">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                <div class="nk-int-st">
                                                    <input type="text" class="form-control input-sm" placeholder="Unit" name="unit" value="{{ old('unit') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-example-int form-horizental">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                <div class="nk-int-st">
                                                    <input type="number" class="form-control input-sm" placeholder="Item Price" name="price" value="{{ old('price') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
